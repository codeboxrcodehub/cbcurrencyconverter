...
class CBCurrencyConverterWidget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		if ( $layout == 'list' ) {
			echo CBCurrencyConverterHelper::cbxcclistview( 'widget', $atts ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
		} elseif ( $layout == 'cal' ) {
			echo CBCurrencyConverterHelper::cbxcccalcview( 'widget', $atts );// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
	...
	public function form( $instance ) {
        ...
        <div class="cbcurrencyconverter-admin-widget-wrap" data-old="0">
            ...
            <div class="selecttwo-select-wrapper">
                <label for="<?php echo esc_attr( $this->get_field_id( 'layout' ) ); ?>"><?php esc_html_e( 'Select Layout:', 'cbcurrencyconverter' ); ?></label>
                <select name="<?php echo esc_attr( $this->get_field_name( 'layout' ) ); ?>"
                        id="<?php echo esc_attr( $this->get_field_id( 'layout' ) ); ?>"
                        class="selecttwo-select widefat">
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'decimal_point ' ) ); ?>">
					<?php esc_html_e( 'Decimal Point', 'cbcurrencyconverter' ); ?>
                    <input class="widefat decimal_point"
                           id="<?php echo esc_attr( $this->get_field_id( 'decimal_point' ) ); ?>"
                           name="<?php echo esc_attr( $this->get_field_name( 'decimal_point' ) ); ?>" type="number"
                           value="<?php echo absint( $decimal_point ); ?>" />
                </label>
            </p>
            <p>
            <h3><?php esc_html_e( 'Calculator settings', 'cbcurrencyconverter' ) ?></h3></p>
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'calc_title' ) ); ?>">
					<?php esc_html_e( 'Calculator Header:', 'cbcurrencyconverter' ); ?>
                    <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'calc_title' ) ); ?>"
                           name="<?php echo esc_attr( $this->get_field_name( 'calc_title' ) ); ?>" type="text"
                           value="<?php echo esc_attr( $calc_title ); ?>" /> </label>
            </p>
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'calc_default_amount' ) ); ?>">
					<?php esc_html_e( 'Default Amount for Calculator', 'cbcurrencyconverter' ); ?>
                    <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'calc_default_amount' ) ); ?>"
                           name="<?php echo esc_attr( $this->get_field_name( 'calc_default_amount' ) ); ?>"
			...
			?>
            <div class="selecttwo-select-wrapper">
                <label for="<?php echo esc_attr( $this->get_field_id( 'calc_from_currencies' ) ); ?>"><?php esc_html_e( 'Calculator Enabled From Currencies', 'cbcurrencyconverter' ); ?></label>
                <div class="clear clearfix"></div>
                <select name="<?php echo esc_attr( $this->get_field_name( 'calc_from_currencies' ) ) . '[]'; ?>"
                        id="<?php echo esc_attr( $this->get_field_id( 'calc_from_currencies' ) ); ?>"
                        multiple="multiple" class="widefat selecttwo-select calc_from_currencies">
					<?php foreach ( $all_currencies as $key => $title ) { ?>
                        <option value="<?php echo esc_attr( $key ); ?>" <?php echo in_array( $key, $calc_from_currencies ) ? 'selected ' : ''; ?>>
							<?php echo esc_html( $title ) . ' - ' . esc_html( $key ); ?>
                        </option>
					<?php } ?>
                </select>
            </div>
			...
			?>
            <div class="selecttwo-select-wrapper">
                <label for="<?php echo esc_attr( $this->get_field_id( 'calc_from_currency' ) ); ?>"><?php esc_html_e( 'Calculator From Default Currency', 'cbcurrencyconverter' ); ?></label>
                <select name="<?php echo esc_attr( $this->get_field_name( 'calc_from_currency' ) ); ?>"
                        id="<?php echo esc_attr( $this->get_field_id( 'calc_from_currency' ) ); ?>"
                        class="selecttwo-select widefat calc_from_currency">
					<?php
					foreach ( $all_currencies as $key => $title ) {
						...
						?>
                        <option value="<?php echo esc_attr( $key ); ?>"<?php selected( $key, $calc_from_currency ); ?>>
							<?php echo esc_html( $title ) . ' - ' . esc_html( $key ); ?>
                        </option>
					<?php } ?>
                </select>
            ...
            <div class="selecttwo-select-wrapper">
                <label for="<?php echo esc_attr( $this->get_field_id( 'calc_to_currencies' ) ); ?>"><?php esc_html_e( 'Calculator Enabled To Currencies', 'cbcurrencyconverter' ); ?></label>
                <div class="clear clearfix"></div>
                <select name="<?php echo esc_attr( $this->get_field_name( 'calc_to_currencies' ) ) . '[]'; ?>"
                        id="<?php echo esc_attr( $this->get_field_id( 'calc_to_currencies' ) ); ?>" multiple="multiple"
                        class="widefat selecttwo-select calc_to_currencies">
					<?php
					foreach ( $all_currencies as $key => $title ) {
						?>
                        <option value="<?php echo esc_attr( $key ); ?>" <?php echo in_array( $key, $calc_to_currencies ) ? 'selected ' : ''; ?>>
							<?php echo esc_html( $title ) . ' - ' . esc_html( $key ); ?>
                        </option>
					<?php } ?>
                </select>
            ...
            <div class="selecttwo-select-wrapper">
                <label for="<?php echo esc_attr( $this->get_field_id( 'calc_to_currency' ) ); ?>"><?php esc_html_e( 'Calculator To Default Currency', 'cbcurrencyconverter' ); ?></label>
                <select name="<?php echo esc_attr( $this->get_field_name( 'calc_to_currency' ) ); ?>"
                        id="<?php echo esc_attr( $this->get_field_id( 'calc_to_currency' ) ); ?>"
                        class="selecttwo-select widefat calc_to_currency">
					<?php
					foreach ( $all_currencies as $key => $title ) {
						...
						?>
                        <option
                                value="<?php echo esc_attr( $key ); ?>"<?php selected( $key, $calc_to_currency ); ?>>
							<?php echo esc_html( $title ) . ' - ' . esc_html( $key ); ?>
                        </option>
					<?php } ?>
                </select>
            </div>
            <p><h3><?php esc_html_e( 'List settings', 'cbcurrencyconverter' ) ?></h3></p>
            <p>
                <label for="<?php echo esc_attr($this->get_field_id( 'list_title' )); ?>">
					<?php esc_html_e( 'List Header:', 'cbcurrencyconverter' ); ?>
                    <input class="widefat" id="<?php echo esc_attr($this->get_field_id( 'list_title' )); ?>"
                           name="<?php echo esc_attr($this->get_field_name( 'list_title' )); ?>" type="text"
                           value="<?php echo esc_attr($list_title); ?>" /> </label>
            </p>
            <p>
                <label for="<?php echo esc_attr($this->get_field_id( 'list_default_amount' )); ?>">
					<?php esc_html_e( 'Default Amount for List', 'cbcurrencyconverter' ); ?>
                    <input class="widefat" id="<?php echo esc_attr($this->get_field_id( 'list_default_amount')); ?>"
                           name="<?php echo esc_attr($this->get_field_name( 'list_default_amount' )); ?>" type="number" step="any"
                           value="<?php echo floatval( $list_default_amount ); ?>" /> </label>
            </p>
            <div class="selecttwo-select-wrapper cbcurrencylist">
                <label for="<?php echo esc_attr($this->get_field_id( 'list_to_currencies' )); ?>"><?php esc_html_e( 'List To Currencies', 'cbcurrencyconverter' ); ?></label>
                <div class="clear clearfix"></div>
                <select name="<?php echo esc_attr($this->get_field_name( 'list_to_currencies' )) . '[]'; ?>"
                        id="<?php echo esc_attr($this->get_field_id( 'list_to_currencies' )); ?>" multiple="multiple"
                        class="widefat selecttwo-select">
					<?php foreach ( $all_currencies as $index => $currency ) { ?>
                        <option
                                value="<?php echo esc_attr($index); ?>"<?php echo in_array( $index, $list_to_currencies ) ? 'selected ' : ''; ?>><?php echo esc_html($currency) . ' - ' . esc_html($index); ?></option>
					<?php } ?>
                </select>
            </div>
            <div class="selecttwo-select-wrapper">
                <label for="<?php echo esc_attr($this->get_field_id( 'list_from_currency' )); ?>"><?php esc_html_e( 'List Default From Currency', 'cbcurrencyconverter' ); ?></label>
                <select name="<?php echo esc_attr($this->get_field_name( 'list_from_currency' )); ?>"
                        id="<?php echo esc_attr($this->get_field_id( 'list_from_currency' )); ?>"
                        class="selecttwo-select widefat">
					<?php foreach ( $all_currencies as $index => $all_currenciescalc ) { ?>
                        <option
                                value="<?php echo esc_attr($index); ?>"<?php selected( $index, $list_from_currency ); ?>><?php echo esc_html($all_currenciescalc) . ' - ' . esc_html($index); ?></option>
					<?php } ?>
                </select>
            </div>
